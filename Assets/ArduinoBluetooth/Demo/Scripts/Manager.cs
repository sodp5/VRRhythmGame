...
public class Manager : MonoBehaviour {
	...
	//===============================================
	public UnityEvent pressQ, pressW, pressE, pressR;
	...
	void Start () {
		...
		*/
		...
		deviceName = "PUPPY"; //bluetooth should be turned ON; // 페어링되는 아두이노 블루투스 이름과 같아야 합니다.
	...
	void OnMessageReceived () {
		...
		if (received_message.Contains ("q")) {
			pressQ.Invoke();
		}
		...
		if (received_message.Contains("e"))
		{
			pressE.Invoke();
		}

		if (received_message.Contains("r"))
		{
			pressR.Invoke();
		}
	}
